...
export default function Questions({ score, results }) {
  ...
  return (
    <div
      className={
        showScore
          ? `md:w-1/2 md:h-1/3 bg-blue-500/75 rounded-md text-white flex flex-col items-center justify-center fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2`
          : `hidden`
      }
    >
      {" "}
